HirealchemyHcl.controller('MessageController', function ($scope, $q, $http) {  
      
        $scope.table = true;
	$scope.add_message = false;
	...
	$scope.SaveMessage = function() {
	    ...
	    if($scope.phone == '') {
		$scope.phone_error = 'has-error';
	    }else {
		$scope.phone_error = '';	
	    }
	    if($scope.message == '') {
		$scope.message_error = 'has-error';		
	    }else {
		$scope.message_error = '';	
	    }
	    if($scope.phone == '' || $scope.message == '') {
	    	return false;
	    }
